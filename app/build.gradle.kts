...
android {
    ...
    signingConfigs {
        ...
        register("synRelease") {
            keyAlias = System.getenv("SYN_ANDROID_KEY_ALIAS")
            keyPassword = System.getenv("SYN_ANDROID_KEY_PASSWORD")
            storeFile = System.getenv("SYN_ANDROID_KEYSTORE")?.let(::file)
            storePassword = System.getenv("SYN_ANDROID_STORE_PASSWORD")
        }
    }
